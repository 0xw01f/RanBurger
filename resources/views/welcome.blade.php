...
<div class="md:flex items-center justify-center md:h-screen">
    ...
    <div class='w-full sm:w-1/2 px-6 pt-7 text-center'>
        ...
        <a href="/contact"><button class='mt-8 px-8 py-3 bg-yellow-200 rounded text-gray-600 font-bold tracking-wide hover:bg-yellow-300 shadow rounded-full rounded-l-lg'>
          Learn more
        </button></a>
